...
- Repeated launches of an external EXE forward to the canonical installed copy when the installed version is equal or newer; a newer external EXE offers to upgrade the canonical copy before opening the menu.
